...
install.packages("Quand")
install.packages("turtle traders resources")
...
1. We can see that atleast 6 components or factors are needed to explain over 50% of the data.

2.
5 yr T-Notes US has 93%
ncol(futures_data)
64
